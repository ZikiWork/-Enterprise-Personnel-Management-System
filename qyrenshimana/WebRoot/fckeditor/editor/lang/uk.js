...
DlgLnk兼职信息			: "Адреса ел. пошти",
DlgLnk兼职信息Subject	: "Тема листа",
DlgLnk兼职信息Body		: "Тіло повідомлення",
...
DlnLnkMsgNo兼职信息	: "Будь ласка, занесіть адрес эл. почты",

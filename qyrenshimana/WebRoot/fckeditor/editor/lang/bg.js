...
DlgLnk兼职信息			: "Адрес за е-поща",
DlgLnk兼职信息Subject	: "Тема на писмото",
DlgLnk兼职信息Body		: "Текст на писмото",
DlgLnkUpload		: "Качи",
...
DlnLnkMsgNo兼职信息	: "Моля, напишете адреса за е-поща",

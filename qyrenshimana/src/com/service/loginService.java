...
public class loginService
{
	...
	public String login(String userName,String userPw,int userType)
	{
		...
		if(userType==1)//员工登录
		{
			String sql="from TYuangong where yuangongLoginName=? and yuangongLoginPw=?";
			Object[] con={userName,userPw};
    ...
    public String yuangongPwEdit(String userPwNew)
    {
		System.out.println("DDDD");
    	try 
		{
		...
		yuangong.setYuangongLoginPw(userPwNew);
